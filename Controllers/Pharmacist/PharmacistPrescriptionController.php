...
class PharmacistPrescriptionController extends Controller
{
    ...
    public function dispense(Request $request, $id)
    {
        try {
            ...
            return response()->json([
                'success' => true,
                'message' => 'Prescription dispensed successfully. Patient should proceed to receptionist for checkout.',
            ...
            return response()->json([
                'success' => false,
                'message' => 'Failed to dispense prescription. Please try again.'
            ], 500);
        }
    }
}