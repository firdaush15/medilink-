            ...
            <div class="form-row">
              <div class="form-group">
                ...
                <input type="text" name="medicines[0][medicine_name]"
                  ...
                  class="medicine-autocomplete" required>
                <small>Type at least 2 characters to search inventory</small>
              </div>

              <div class="form-group">
                <label>Dosage <span class="required">*</span></label>
                <input type="text" name="medicines[0][dosage]" placeholder="e.g., 500mg" required>
              </div>
            </div>

            <div class="form-group">
              <label>Frequency/Instructions <span class="required">*</span></label>
              <input type="text" name="medicines[0][frequency]" placeholder="e.g., 3 times daily after meals for 7 days" required>
            </div>
          </div>
        </div>
...
5. Patient education provided:
   ...
   - Self-care strategies`
                ...
                medicines.forEach(med => {
                  ...
                  item.innerHTML = `
                            ...
                            <small style="display: block; color: #666; margin-top: 4px;">
                                ...
                                <span style="color: ${med.quantity_in_stock > 0 ? '#16a34a' : '#dc2626'}; font-weight: 600;">
                  ...
                  item.addEventListener('click', () => {
                    ...
                    // Auto-fill strength in the dosage field
      ...
      // Updated addMedicineItem function with autocomplete
      function addMedicineItem() {
        ...
        <div class="form-group">
            ...
            <input type="text" name="medicines[${medicineCount}][frequency]" 
                   placeholder="e.g., 3 times daily after meals for 7 days" required>
        </div>
    `;
      ...
      // Initialize autocomplete for existing medicine inputs on page load
      document.addEventListener('DOMContentLoaded', function() {
        // Initialize for all existing medicine name inputs
        document.querySelectorAll('input[name*="[medicine_name]"]').forEach(input => {
          input.classList.add('medicine-autocomplete');
